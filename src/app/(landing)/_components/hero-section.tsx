    ...
    <>
      ...
      <section className="overflow-hidden bg-white dark:bg-transparent">
        <div className="relative mx-auto max-w-5xl px-6 py-28 lg:py-24">
          <div className="relative z-10 mx-auto max-w-2xl text-center">
            ...
            <p className="mx-auto my-8 max-w-2xl text-xl">
              Stack your favorite subreddits in resizable columns. Chat with
              them. Summarize threads. Discover insights fast, fun, and
              effortless.
            </p>

            {/* CTA button */}
            <div
              className="mx-auto max-w-sm relative h-full bg-[#ff622e] 
        ...
        <p className="text-sm text-muted-foreground mt-1 flex items-center justify-center gap-1.5">
          <Sparkles className="w-4 h-4 text-yellow-400" /> No credit card
          required
        </p> */}

        <div className="mx-auto md:-mt-2 max-w-7xl">
